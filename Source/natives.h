...
namespace PED
{
	static void _APPLY_PED_OVERLAY(Ped ped, Hash collectionHash, Hash decorationHash) { invoke<Void>(0x5F5D1665E352A839, ped, collectionHash, decorationHash); } // 0x5F5D1665E352A839 0x70559AC7
...
namespace GRAPHICS
{
	...
	static BOOL _HAS_VEHICLE_GOT_DECAL(Any p0, Any p1) { return invoke<BOOL>(0x060D935D3981A275, p0, p1); } // 0x060D935D3981A275 0x6D58F73B
